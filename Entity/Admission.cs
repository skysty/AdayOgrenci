...
namespace AdayOgrenci.Entity
{
    public class Admission
    {
        ...
        public bool EducatedPreparationSchool { get; set; }
        public string FirstAdmissionDate { get; set; }
        public bool IsThisFirstAdmission { get; set; }
        public string SystemInterfaceLanguage { get; set; }
        public string PlacementOfUniversity { get; set; }
